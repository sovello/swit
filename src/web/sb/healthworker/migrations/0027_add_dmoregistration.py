...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DMORegistration'
        db.create_table('healthworker_dmoregistration', (
        ...
        db.send_create_signal('healthworker', ['DMORegistration'])


    def backwards(self, orm):
        # Deleting model 'DMORegistration'
        db.delete_table('healthworker_dmoregistration')
